...
// arrowComThis();
// parâmetro padrão
function contagemRegressiva(inicio = 3, fim = inicio + 2) {
...
function retornarArrayDinamico(...args) {
    return args;
}
...
const cientista = { primeiroNome2: "Will", experiencia: 12 };
...
esperar3s((mensagem) => console.log(mensagem));
